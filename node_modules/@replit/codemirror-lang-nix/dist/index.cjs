...
const scanString = new lr.ExternalTokenizer((input) => {
...
const scanIndString = new lr.ExternalTokenizer((input) => {
...
function nix() {
    return new language.LanguageSupport(nixLanguage, nixLanguage.data.of({
