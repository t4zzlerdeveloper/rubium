...
const longExpression = new lr.ExternalTokenizer(input => {
...
const shortExpression = new lr.ExternalTokenizer(input => {
...
const svelteHighlighting = highlight.styleTags({
    ...
    "UnquotedAttributeValue": highlight.tags.attributeValue,
    "DoubleQuote SingleQuote AttributeValueContent": highlight.tags.attributeValue,
    ...
    "ComponentName": highlight.tags.className,
    "SvelteElementNamespace": highlight.tags.namespace,
    "SvelteElementType": highlight.tags.tagName,
    "StyleAttributeName": highlight.tags.propertyName,
    "BlockType": highlight.tags.controlKeyword,
    "BlockPrefix": highlight.tags.typeOperator,
    "UnknownBlock/BlockType": highlight.tags.invalid,
    "UnknownBlockContent": highlight.tags.invalid,
    "if then catch": highlight.tags.controlKeyword,
    "as": highlight.tags.definitionOperator,
    "Variable": highlight.tags.variableName,
    "Modifier": highlight.tags.modifier,
    "DirectlyInterpolatedAttributeValue": highlight.tags.attributeValue,
    "DirectiveOn/DirectiveName": highlight.tags.controlKeyword,
    "DirectiveOn/DirectiveTarget": highlight.tags.typeName,
    "DirectiveUse/DirectiveName": highlight.tags.controlKeyword,
    "DirectiveUse/DirectiveTarget": highlight.tags.function(highlight.tags.variableName),
    "DirectiveBind/DirectiveName": highlight.tags.controlKeyword,
    "DirectiveBind/DirectiveTarget": highlight.tags.variableName,
    "DirectiveLet/DirectiveName": highlight.tags.definitionKeyword,
    "DirectiveLet/DirectiveTarget": highlight.tags.definition(highlight.tags.variableName),
    "DirectiveTransition/DirectiveName": highlight.tags.operatorKeyword,
    "DirectiveTransition/DirectiveTarget": highlight.tags.function(highlight.tags.variableName),
    "DirectiveIn/DirectiveName": highlight.tags.operatorKeyword,
    "DirectiveIn/DirectiveTarget": highlight.tags.function(highlight.tags.variableName),
    "DirectiveOut/DirectiveName": highlight.tags.operatorKeyword,
    "DirectiveOut/DirectiveTarget": highlight.tags.function(highlight.tags.variableName),
    "DirectiveAnimate/DirectiveName": highlight.tags.operatorKeyword,
    "DirectiveAnimate/DirectiveTarget": highlight.tags.function(highlight.tags.variableName),
    "DirectiveClass/DirectiveName": highlight.tags.attributeName,
    "DirectiveClass/DirectiveTarget": highlight.tags.variableName,
    "DirectiveStyle/DirectiveName": highlight.tags.attributeName,
    "DirectiveStyle/DirectiveTarget": highlight.tags.propertyName
});
...
const expressionParser = javascript.parser.configure({ top: "SingleExpression" });
...
const svelteLanguage = language.LRLanguage.define({
    // @ts-expect-error
    ...
    languageData: {
        ...
        wordChars: "-._",
        autocomplete: langHtml.htmlCompletionSource
    }
});
function svelte() {
    return new language.LanguageSupport(svelteLanguage, [
...
const autoCloseTags = view.EditorView.inputHandler.of((view, from, to, text) => {
    ...
    let changes = state$1.changeByRange(range => {
        var _a, _b, _c;
        let { head } = range;
        let around = language.syntaxTree(state$1).resolveInner(head, -1);
        let name;
...
exports.svelteLanguage = svelteLanguage;
exports.svelteParser = parser;
