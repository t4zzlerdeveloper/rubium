...
const diagramText = new lr.ExternalTokenizer((input) => {
...
// This file was generated by lezer-generator. You probably shouldn't edit it.
const parser$7 = lr.LRParser.deserialize({
  version: 14,
...
const mermaidTags = {
    diagramName: highlight.Tag.define(highlight.tags.typeName),
};
const mindmapTags = {
    diagramName: highlight.Tag.define(mermaidTags.diagramName),
...
const pieTags = {
    diagramName: highlight.Tag.define(mermaidTags.diagramName),
    lineComment: highlight.Tag.define(highlight.tags.lineComment),
    number: highlight.Tag.define(highlight.tags.number),
    showData: highlight.Tag.define(highlight.tags.keyword),
    string: highlight.Tag.define(highlight.tags.string),
    title: highlight.Tag.define(highlight.tags.keyword),
    titleText: highlight.Tag.define(highlight.tags.string),
};
const flowchartTags = {
    diagramName: highlight.Tag.define(mermaidTags.diagramName),
    keyword: highlight.Tag.define(highlight.tags.keyword),
    lineComment: highlight.Tag.define(highlight.tags.lineComment),
    link: highlight.Tag.define(highlight.tags.contentSeparator),
    nodeEdge: highlight.Tag.define(highlight.tags.contentSeparator),
    nodeEdgeText: highlight.Tag.define(highlight.tags.string),
    nodeId: highlight.Tag.define(highlight.tags.variableName),
    nodeText: highlight.Tag.define(highlight.tags.string),
    number: highlight.Tag.define(highlight.tags.number),
    orientation: highlight.Tag.define(highlight.tags.modifier),
    string: highlight.Tag.define(highlight.tags.string),
};
const sequenceTags = {
    diagramName: highlight.Tag.define(mermaidTags.diagramName),
    arrow: highlight.Tag.define(highlight.tags.contentSeparator),
    keyword1: highlight.Tag.define(highlight.tags.keyword),
    keyword2: highlight.Tag.define(highlight.tags.controlKeyword),
    lineComment: highlight.Tag.define(highlight.tags.lineComment),
    messageText1: highlight.Tag.define(highlight.tags.string),
    messageText2: highlight.Tag.define(highlight.tags.content),
    nodeText: highlight.Tag.define(highlight.tags.variableName),
    position: highlight.Tag.define(highlight.tags.modifier),
};
const journeyTags = {
    diagramName: highlight.Tag.define(mermaidTags.diagramName),
    actor: highlight.Tag.define(highlight.tags.variableName),
    keyword: highlight.Tag.define(highlight.tags.keyword),
    lineComment: highlight.Tag.define(highlight.tags.lineComment),
    score: highlight.Tag.define(highlight.tags.number),
    text: highlight.Tag.define(highlight.tags.string),
};
const requirementTags = {
    ...
    lineComment: highlight.Tag.define(highlight.tags.lineComment),
    number: highlight.Tag.define(highlight.tags.number),
    quotedString: highlight.Tag.define(highlight.tags.string),
    unquotedString: highlight.Tag.define(highlight.tags.content),
};
const ganttTags = {
    diagramName: highlight.Tag.define(mermaidTags.diagramName),
    keyword: highlight.Tag.define(highlight.tags.keyword),
...
const parser$6 = lr.LRParser.deserialize({
  version: 14,
...
const titleText = new lr.ExternalTokenizer((input) => {
    if (input.next === 10) {
...
const pieHighlighting = highlight.styleTags({
...
const parser$5 = lr.LRParser.deserialize({
  version: 14,
...
const equal = 61;
const dot = 46;
const nodeText = new lr.ExternalTokenizer((input) => {
...
const nodeEdgeText = new lr.ExternalTokenizer((input) => {
    if (skipCodePoints$2.includes(input.next) ||
        startBracketCodePoints.includes(input.next) ||
        input.next === hyphen ||
        input.next === equal ||
...
const styleText = new lr.ExternalTokenizer((input) => {
...
const flowchartHighlighting = highlight.styleTags({
...
const messageTextToken = new lr.ExternalTokenizer((input) => {
...
const textTokens = new lr.ExternalTokenizer((input) => {
    if (skipCodePoints$1.includes(input.next) ||
...
const sequenceHighlighting = highlight.styleTags({
...
const keywordTokens = new lr.ExternalTokenizer((input) => {
    if (shouldSkip(input))
        return;
    let tokens = '';
...
const textTokens1 = new lr.ExternalTokenizer((input) => {
    if (shouldSkip(input))
        return;
    while (input.next !== 10 && input.next !== -1) {
        input.advance();
...
const textTokens2 = new lr.ExternalTokenizer((input) => {
    if (shouldSkip(input))
        return;
...
const textTokens3 = new lr.ExternalTokenizer((input) => {
    if (shouldSkip(input))
        return;
...
const journeyHighlighting = highlight.styleTags({
...
const relationshipStart = new lr.ExternalTokenizer((input) => {
...
const requirementHighlighting = highlight.styleTags({
...
const textToken = new lr.ExternalTokenizer((input) => {
...
const ganttHighlighting = highlight.styleTags({
...
const mermaidLanguage = language.LRLanguage.define({
...
const pieLanguage = language.LRLanguage.define({
    name: MermaidLanguageType.Pie,
    parser: parser$5,
});
const flowchartLanguage = language.LRLanguage.define({
    name: MermaidLanguageType.Flowchart,
    parser: parser$4,
});
const sequenceLanguage = language.LRLanguage.define({
    name: MermaidLanguageType.Sequence,
    parser: parser$3,
});
const journeyLanguage = language.LRLanguage.define({
    name: MermaidLanguageType.Journey,
    parser: parser$2,
});
const requirementLanguage = language.LRLanguage.define({
    name: MermaidLanguageType.Requirement,
    parser: parser$1,
});
const ganttLanguage = language.LRLanguage.define({
    name: MermaidLanguageType.Gantt,
    parser: parser,
});

function mermaid() {
    return new language.LanguageSupport(mermaidLanguage);
}
function mindmap() {
    return new language.LanguageSupport(mindmapLanguage);
}
function pie() {
    return new language.LanguageSupport(pieLanguage);
}
function flowchart() {
    return new language.LanguageSupport(flowchartLanguage);
}
function sequence() {
    return new language.LanguageSupport(sequenceLanguage);
}
function journey() {
    return new language.LanguageSupport(journeyLanguage);
}
function requirement() {
    return new language.LanguageSupport(requirementLanguage);
}
function gantt() {
    return new language.LanguageSupport(ganttLanguage);
}

const mermaidLanguageDescription = language.LanguageDescription.of({
    name: MermaidDescriptionName.Mermaid,
    load: async () => {
        return mermaid();
    },
});
const mindmapLanguageDescription = language.LanguageDescription.of({
    name: MermaidDescriptionName.Mindmap,
    load: async () => {
        return mindmap();
    },
});
const pieLanguageDescription = language.LanguageDescription.of({
    name: MermaidDescriptionName.Pie,
    load: async () => {
        return pie();
    },
});
const flowchartLanguageDescription = language.LanguageDescription.of({
...
const sequenceLanguageDescription = language.LanguageDescription.of({
...
const journeyLanguageDescription = language.LanguageDescription.of({
    name: MermaidDescriptionName.Journey,
    load: async () => {
        return journey();
    },
});
const requirementLanguageDescription = language.LanguageDescription.of({
...
const ganttLanguageDescription = language.LanguageDescription.of({
...
const foldByIndent = () => {
    return language.foldService.of((state, lineStart, lineEnd) => {
...
exports.flowchartLanguage = flowchartLanguage;
exports.flowchartLanguageDescription = flowchartLanguageDescription;
exports.flowchartTags = flowchartTags;
exports.foldByIndent = foldByIndent;
exports.gantt = gantt;
exports.ganttLanguage = ganttLanguage;
exports.ganttLanguageDescription = ganttLanguageDescription;
exports.ganttTags = ganttTags;
exports.journey = journey;
exports.journeyLanguage = journeyLanguage;
exports.journeyLanguageDescription = journeyLanguageDescription;
exports.journeyTags = journeyTags;
exports.mermaid = mermaid;
exports.mermaidLanguage = mermaidLanguage;
exports.mermaidLanguageDescription = mermaidLanguageDescription;
exports.mermaidTags = mermaidTags;
exports.mindmap = mindmap;
exports.mindmapLanguage = mindmapLanguage;
exports.mindmapLanguageDescription = mindmapLanguageDescription;
exports.mindmapTags = mindmapTags;
exports.pie = pie;
exports.pieLanguage = pieLanguage;
exports.pieLanguageDescription = pieLanguageDescription;
exports.pieTags = pieTags;
exports.requirement = requirement;
exports.requirementLanguage = requirementLanguage;
exports.requirementLanguageDescription = requirementLanguageDescription;
exports.requirementTags = requirementTags;
exports.sequence = sequence;
exports.sequenceLanguage = sequenceLanguage;
exports.sequenceLanguageDescription = sequenceLanguageDescription;
exports.sequenceTags = sequenceTags;
