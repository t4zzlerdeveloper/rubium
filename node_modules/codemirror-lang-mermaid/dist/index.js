import { LRLanguage, LanguageSupport, LanguageDescription, foldService } from '@codemirror/language';
import { parseMixed } from '@lezer/common';
import { ExternalTokenizer, LRParser, ContextTracker } from '@lezer/lr';
...
const diagramText = new ExternalTokenizer((input) => {
...
const titleText = new ExternalTokenizer((input) => {
    if (input.next === 10) {
...
const pieHighlighting = styleTags({
...
const equal = 61;
const dot = 46;
const nodeText = new ExternalTokenizer((input) => {
...
const nodeEdgeText = new ExternalTokenizer((input) => {
    if (skipCodePoints$2.includes(input.next) ||
        startBracketCodePoints.includes(input.next) ||
        input.next === hyphen ||
        input.next === equal ||
...
const styleText = new ExternalTokenizer((input) => {
...
const flowchartHighlighting = styleTags({
    '( )': tags.paren,
    '[ ]': tags.squareBracket,
    '{ }': tags.brace,
    '<': tags.angleBracket,
...
const messageTextToken = new ExternalTokenizer((input) => {
...
const textTokens = new ExternalTokenizer((input) => {
    if (skipCodePoints$1.includes(input.next) ||
...
const sequenceHighlighting = styleTags({
...
const keywordTokens = new ExternalTokenizer((input) => {
    if (shouldSkip(input))
        return;
    let tokens = '';
...
const textTokens1 = new ExternalTokenizer((input) => {
    if (shouldSkip(input))
        return;
    while (input.next !== 10 && input.next !== -1) {
        input.advance();
...
const textTokens2 = new ExternalTokenizer((input) => {
    if (shouldSkip(input))
        return;
...
const textTokens3 = new ExternalTokenizer((input) => {
    if (shouldSkip(input))
        return;
...
const journeyHighlighting = styleTags({
...
const relationshipStart = new ExternalTokenizer((input) => {
...
const requirementHighlighting = styleTags({
...
const textToken = new ExternalTokenizer((input) => {
...
const ganttHighlighting = styleTags({
...
const mermaidLanguage = LRLanguage.define({
...
const pieLanguage = LRLanguage.define({
    name: MermaidLanguageType.Pie,
    parser: parser$5,
});
const flowchartLanguage = LRLanguage.define({
    name: MermaidLanguageType.Flowchart,
    parser: parser$4,
});
const sequenceLanguage = LRLanguage.define({
    name: MermaidLanguageType.Sequence,
    parser: parser$3,
});
const journeyLanguage = LRLanguage.define({
    name: MermaidLanguageType.Journey,
    parser: parser$2,
});
const requirementLanguage = LRLanguage.define({
    name: MermaidLanguageType.Requirement,
    parser: parser$1,
});
const ganttLanguage = LRLanguage.define({
...
const mindmapLanguageDescription = LanguageDescription.of({
    name: MermaidDescriptionName.Mindmap,
    load: async () => {
        return mindmap();
    },
});
const pieLanguageDescription = LanguageDescription.of({
    name: MermaidDescriptionName.Pie,
    load: async () => {
        return pie();
    },
});
const flowchartLanguageDescription = LanguageDescription.of({
...
const sequenceLanguageDescription = LanguageDescription.of({
...
const journeyLanguageDescription = LanguageDescription.of({
    name: MermaidDescriptionName.Journey,
    load: async () => {
        return journey();
    },
});
const requirementLanguageDescription = LanguageDescription.of({
...
const ganttLanguageDescription = LanguageDescription.of({
...
export { flowchart, flowchartLanguage, flowchartLanguageDescription, flowchartTags, foldByIndent, gantt, ganttLanguage, ganttLanguageDescription, ganttTags, journey, journeyLanguage, journeyLanguageDescription, journeyTags, mermaid, mermaidLanguage, mermaidLanguageDescription, mermaidTags, mindmap, mindmapLanguage, mindmapLanguageDescription, mindmapTags, pie, pieLanguage, pieLanguageDescription, pieTags, requirement, requirementLanguage, requirementLanguageDescription, requirementTags, sequence, sequenceLanguage, sequenceLanguageDescription, sequenceTags };
